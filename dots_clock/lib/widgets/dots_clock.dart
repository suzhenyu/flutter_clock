...
import 'package:dots_clock/widgets/dots_painter.dart';
...
class DotsClockState extends State<DotsClock> with TickerProviderStateMixin {
  ...
  late List<List<double>> _dotsGrid;
  ...
  late AnimationController _dotTransitionController;

  /// [Animation] values for the dot transition animations.
  late Animation<double> _dotTransitionAnimation;
