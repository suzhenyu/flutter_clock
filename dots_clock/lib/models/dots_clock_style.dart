...
class DotsClockStyle {
  ...
  DotsClockStyle copyWith({
    Color brightColor = Colors.black,
    Color darkColor = Colors.white,
    Color brightBackgroundColor = Colors.white,
    Color darkBackgroundColor = Colors.black,
    Duration idleAnimationDuration = const Duration(milliseconds: 10000),
    Duration transitionAnimationDuration = const Duration(milliseconds: 3500),
    required double dotSpacing,
    double dotBaseSize = 1.0,
    required double dotActiveScale,
    required String fontPath,
    double fontSize = 0.4,
    double fontSpacing = 1.0,
    double middleSpacing = 0.0,
    double xOffset = 0.0,
    double yOffset = 0.0,
    bool shouldCenterVertically = true,
    bool shouldCenterHorizontally = false,
    required Map<String, double> charXPosCorrections,
    required Function(int rows, int columns) gridBuilder,
  }) {
    return DotsClockStyle(
      ...
      idleAnimationDuration: idleAnimationDuration,
      transitionAnimationDuration: transitionAnimationDuration,
      dotSpacing: dotSpacing,
      dotBaseSize: dotBaseSize,
      dotActiveScale: dotActiveScale,
      fontPath: fontPath,
      gridBuilder: gridBuilder,
      charXPosCorrections: charXPosCorrections,
      fontSize: fontSize,
      fontSpacing: fontSpacing,
      middleSpacing: middleSpacing,
      xOffset: xOffset,
      yOffset: yOffset,
      shouldCenterVertically: shouldCenterVertically,
      shouldCenterHorizontally: shouldCenterHorizontally,
    );
  }
