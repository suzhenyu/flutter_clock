...
class TetrisClock extends StatefulWidget {
  const TetrisClock(this.model, {super.key});

  final ClockModel model;

  @override
  State<TetrisClock> createState() => _TetrisClockState();
}
...
class _TetrisClockState extends State<TetrisClock> {
  ...
  /* last digit value */
  List lastValue = List.generate(4, (_) => -1);
  ...
  */
  ...
  static Paint blackPaint1 = Paint()..color = const Color(0xff1b1b1b);
  static Paint blackPaint2 = Paint()..color = const Color(0xFF373737);

  static Paint bluePaint1 = Paint()..color = const Color(0xFF003c8f);
  static Paint bluePaint2 = Paint()..color = const Color(0xFF005cb2);

  static Paint greenPaint1 = Paint()..color = const Color(0xFF1b5e20);
  static Paint greenPaint2 = Paint()..color = const Color(0xFF388e3c);

  static Paint purplePaint1 = Paint()..color = const Color(0xFF4a0072);
  static Paint purplePaint2 = Paint()..color = const Color(0xFF9c27b0);

  static Paint redPaint1 = Paint()..color = const Color(0xFF8e0000);
  static Paint redPaint2 = Paint()..color = const Color(0xFFc62828);

  static Paint orangePaint1 = Paint()..color = const Color(0xFFb53d00);
  static Paint orangePaint2 = Paint()..color = const Color(0xFFe65100);

  static Paint yellowPaint1 = Paint()..color = const Color(0xFFf57f17);
  static Paint yellowPaint2 = Paint()..color = const Color(0xFFf9a825);

  static Paint pinkPaint1 = Paint()..color = const Color(0xFFc2185b);
  static Paint pinkPaint2 = Paint()..color = const Color(0xFFe35183);

  static Paint whitePaint1 = Paint()..color = const Color(0xFFbcbcbc);
  static Paint whitePaint2 = Paint()..color = const Color(0xFFeeeeee);

  static Paint greyPaint1 = Paint()..color = const Color(0xFF707070);
  static Paint greyPaint2 = Paint()..color = const Color(0xFFbdbdbd);
  ...
  void updateWeatherCondition() {
    ...
    if (weatherOffset < 0) {
      weatherOffset++;
      updateSelectedWeather(outWeather ?? WeatherCondition.sunny,
          -weatherOffset + maxWeatherOffset);
    }
...
class TetrisNumber {
  ...
  late List colors;
  int pos;
  late List lastBlockData;

  TetrisNumber(List animationData, this.pos) {
    blocks = animationData[animationsteps];
    colors = animationData[blockcolors];
  }
