...
import 'package:circle_clock/components/circle_clock_display.dart';
import 'package:circle_clock/components/clock_readout.dart';
...
class TheClock extends StatefulWidget {
  const TheClock(this.model, {super.key});

  final ClockModel model;

  @override
  State<TheClock> createState() => _TheClockState();
}
