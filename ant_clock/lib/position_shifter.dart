...
class _WalkPositionShifter implements PositionShifter {
  ...
  late Animatable<double> _xAnimatable;

  late Animatable<double> _yAnimatable;

  late Position _position;

  bool _isFinished = false;

  final _LateralStepper _lateralStepper = _LateralStepper();
...
class _TurnPositionShifter implements PositionShifter {
  ...
  late Animatable<double> _bearingAnimatable;
