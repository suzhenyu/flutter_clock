...
class ClockUiInheritedModel extends InheritedModel<String> {
  ...
  bool updateShouldNotify(ClockUiInheritedModel old) {
    return hours != old.hours ||
        minutes != old.minutes ||
        utils.ratio != old.utils.ratio ||
