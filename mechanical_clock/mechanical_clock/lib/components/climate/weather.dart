...
class _AnimatedWeatherState extends AnimatedWidgetBaseState<AnimatedWeather>
  ...
  late List<AnimationController> iconLoopControllers;
...
class WeatherChildrenParentData
  ...
  late double radius, indentationFactor;
}
...
class RenderWeather extends RenderComposition<WeatherCondition,
  ...
  RenderWeather({
    ...
    required Color backgroundHighlightColor,
  ...
  WeatherCondition get condition => conditions[
      (_angle / pi / 2 * conditions.length).round() % conditions.length];
...
class RenderRainy extends RenderWeatherIcon {
  RenderRainy({
    required Animation<double> animation,
    required double angle,
    required int raindrops,
    required Color raindropColor,
    required Color backgroundColor,
    required Color backgroundHighlightColor,
    required Color shadowColor,
    required Color borderColor,
  ...
  @override
  void drawCondition(Canvas canvas) {
    _drawRain(canvas, _raindropColor, radius, 5710, _raindrops, 1.42,
        animationSeed: 31, animationValue: animation.value);
  }
}
...
class RenderThunderstorm extends RenderWeatherIcon {
  ...
  late TweenSequence<double> lightningSequence;
...
class RenderWindy extends RenderWeatherIcon {
  ...
  late TweenSequence<DoubleTuple> pathSequence;
