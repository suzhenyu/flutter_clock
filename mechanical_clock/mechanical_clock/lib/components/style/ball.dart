...
class BallParentData extends ClockChildrenParentData {
  late Offset startPosition, endPosition, destination;
...
class RenderBall
  ...
  late double _radius, _totalDistance;

  late Tween<Offset> _travelTween, _arrivalTween, _departureTween;

  late double _travelDistance, _arrivalDistance, _departureDistance;

  late BallTripStage stage;
