...
class SlideParentData extends ClockChildrenParentData {
  ...
  late Offset start, end, destination;
...
class RenderSlide
  ...
  late Line2d startLine, endLine, travelLine;
  ...
  late TweenSequence<double> leftTravelSequence,
      rightTravelSequence,
      arrivalSequence,
      departureSequence;
  ...
  void performResize() {
    ...
    final ballRadius = compositionData.ballRadius,
        ...
        departureBallLengthFraction = ballLengthFraction * 1.12;
