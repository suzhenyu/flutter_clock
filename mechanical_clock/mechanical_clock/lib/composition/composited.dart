...
class RenderCompositedClock extends RenderComposition<ClockComponent,
  ...
  void performLayout() {
    ...
    temperature!
        .layout(BoxConstraints.tight(temperatureSize), parentUsesSize: false);
  ...
  void _transformedPaint(PaintingContext context, Offset offset) {
    // The transform below does not do anything when the spin up
    // animation is completed.
    if (spinUpAnimation.isCompleted) {
