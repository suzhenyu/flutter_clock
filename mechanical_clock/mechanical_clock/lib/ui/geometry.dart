...
class Line1d {
  ...
  const Line1d({required this.start, required this.end});

  factory Line1d.fromSE({required double start, required double extent}) =>
...
class Line2d {
  Line2d({required this.start, required this.end});
