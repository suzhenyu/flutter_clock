...
import 'package:barbar_clock/data/digits_collection.dart';
import 'package:barbar_clock/model/protected_area.dart';
import 'package:barbar_clock/model/weather_icon.dart';
...
class ClockPainter extends CustomPainter {
  ...
  ClockPainter({
    ...
    required this.newMinute,
        ...
        assert(currentHour.length == 2),
        assert(currentMinute.length == 2),
